...
summary: 'DanioSense (DS) is an automatic tracker designed to overcome challenges in tracking groups of larval zebrafish, such as occlusions and discontinuous movements. By integrating a light convolutional neural network, a centerline extraction algorithm, and an adaptive Kalman filter, DS achieves high tracking accuracy and reidentification, enabling detailed, near real-time quantitative analysis of large-scale larval groups.'
